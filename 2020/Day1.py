...
while b < len(check):
    if (check[a] + check[b] + check[c]) == 2020:
        break
    else:
        b +=1
    if b == len(check):
...
print("C = ", c)
print("Check c", check[c])
print("The total =  ",check[a]*check[b]*check[c])